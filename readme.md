...
2. Go to the [releases](#https://github.com/Sadret/openrct2-scenery-manager/releases) page and download the file
 - [`scenery-manager-2.0.6.js`](https://github.com/Sadret/openrct2-scenery-manager/releases/download/v2.0.6/openrct2-scenery-manager-2.0.6.js) from [release 2.0.6](https://github.com/Sadret/openrct2-scenery-manager/releases/tag/v2.0.6), if you use `0.4.7` or a recent development version
