...
2. Go to the [releases](#https://github.com/Sadret/openrct2-scenery-manager/releases) page and download the file `scenery-manager-2.0.1.js` from the latest release. Save it in the `plugin` subfolder of your OpenRCT2 user directory.\
